...
def main():
    ...
    parser.add_argument("--prompt_en", type=str, default="Directly answer what can be diagnosed with this breast tumor Xray image.", help='English prompt for the first round')
    parser.add_argument("--simplified", action='store_true', help='simplified output mode')
    parser.add_argument("--image_path", type=str, help='Path to the image file')  # 新增的参数
    ...
    with torch.no_grad():
        ...
        while True:
            ...
            if args.simplified:
                ...
                return  # Exit after first response in simplified mode
            else:
